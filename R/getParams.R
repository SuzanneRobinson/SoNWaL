...
getParms<-function(weather=clm_df_full,
                   ...
                   nAge = 3.545,
                   rAge = 0.796,
                   gammaFx = 0.044103832595131,
                   gammaF0 = 0.01646200557456,
                   tgammaF = 91.0444300531049,
                   Rttover = 0.17330883550376,
                   MaxCond = 0.02,
                   ...
                   maxRootDepth=2.5,
                   sigma_zR =2.5, #area/depth explored by 1kg of root biomass
