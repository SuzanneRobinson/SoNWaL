...
function (weather, presc, t = 0, N = 2500, Wl = 0.01, WlDormant = 0, Wr = 0.01, Wsbr = 0.1, 
              ...
              pWsbr.sprouts = 0.9, cod.pred = "3PG", cod.clim = "Average" ,K_s=0.1,V_nr=500,sigma_zR =1,O_nr0=800,E_S=100,
              E_S1 =50,E_S2 =0.01)
        ...
        ## pfsPower = -0.522878745280338, pfsConst = 0.43104582317421,
{
    ...
    names(parms)<-c("pFS2","pFS20","aS","nS","pRx","pRn",
                    ...
                    "pWsbr.sprouts","leaf.grow","leaf.fall","K_s","V_nr","sigma_zR","E_S1","E_S2")
