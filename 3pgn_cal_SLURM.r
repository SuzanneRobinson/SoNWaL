...
#read in and manipulate monthly and weekly data
...
settings = list(
  iterations = iters,
  ## Z = NULL,
  startValue = 4,# internal chain number - dont use these chains for convergence testing 
  nrChains = 1,
  pSnooker = 0.5,
  burnin = round(iters/100*10), # 10 percent of iterations
  ## thin = 1,
  ## f = 2.38,
  ## eps = 0,
  parallel = T,
