...
sitka<-list(weather=weeklyRfall,
            ...
            E_S2 =.8, #how quickly evaporation rate declines with accumulated phase 2 evaporation - based on soil structure
            MaxASW_state=50,
